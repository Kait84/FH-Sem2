...
public class PasswordManager {
    ...
    private static void addExampleEntries(PasswordStore store) {
        PasswordEntry github = new PasswordEntry("github.com", "someRandomUserName", PasswordComplexity.MEDIUM);
        store.add(github);
        PasswordEntry google = new PasswordEntry("google.com", "someMoreRandomUserName", PasswordComplexity.MEDIUM);
        store.add(google);
        PasswordEntry bankOfYourTrust = new PasswordEntry("bankdeinesvertrauens.com", "yourActionalName", PasswordComplexity.PIN);
        store.add(bankOfYourTrust);
    }
